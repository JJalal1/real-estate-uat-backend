...
use App\Http\Controllers\Api\PropertyFinanceAdminController;
...
Route::middleware(['auth.api', 'account.active'])->group(function (): void {
    ...
    Route::get('/admin/finance/summary', [PropertyFinanceAdminController::class, 'summary'])->middleware('permission:finance.view');
    Route::get('/admin/finance/workspace', [PropertyFinanceAdminController::class, 'workspace'])->middleware('permission:finance.view');
    Route::get('/admin/finance/payment-methods', [PropertyFinanceAdminController::class, 'paymentMethods'])->middleware('permission:finance.manage');
    Route::patch('/admin/finance/payment-methods/{method}', [PropertyFinanceAdminController::class, 'updatePaymentMethod'])->middleware('permission:finance.manage');

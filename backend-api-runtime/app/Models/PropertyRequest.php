...
{
    protected $fillable = ['requester_user_id','governorate_id','geo_cell_id','operation_type','property_type','governorate','district','area','budget_min','budget_max','currency','requested_area_min','requested_area_max','rooms','additional_specifications','active_duration_days','status','expires_at','matched_at','closed_at','expired_at'];

...
class MessageThread extends Model
{
    ...
    {
        static::creating(function (MessageThread $thread): void {
            if ($thread->sai_term_id !== null || $thread->property_id === null) {
                return;
            }
            $thread->sai_term_id = Property::query()
                ->whereKey($thread->property_id)

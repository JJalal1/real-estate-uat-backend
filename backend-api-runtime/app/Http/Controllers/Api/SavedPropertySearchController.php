...
class SavedPropertySearchController extends Controller
{
    ...
    private function rules(bool $partial): array
    {
        ...
        return [
            ...
            'filters.area_unit' => ['nullable', Rule::in(['sqm','libna_sanaani','libna_dhamari','qasaba_taizi_ashari','qasaba_taizi_hadawi','qasaba_ibbi'])],
            'filters.min_area_value' => ['nullable', 'numeric', 'min:0'],
            'filters.max_area_value' => ['nullable', 'numeric', 'min:0'],

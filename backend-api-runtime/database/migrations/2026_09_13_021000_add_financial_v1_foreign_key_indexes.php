...
return new class extends Migration
{
    ...
    {
        Schema::table('property_deal_financial_terms', fn (Blueprint $table) => $table->dropIndex('pdf_terms_agreement_revision_idx'));
        Schema::table('property_payments', function (Blueprint $table): void {
            $table->dropIndex('property_payments_deal_term_idx');
            $table->dropIndex('property_payments_reviewer_idx');
        });
        Schema::table('property_payment_allocations', fn (Blueprint $table) => $table->dropIndex('property_payment_alloc_beneficiary_idx'));
        Schema::table('property_manual_payment_confirmations', fn (Blueprint $table) => $table->dropIndex('property_manual_confirm_user_idx'));
        Schema::table('property_payouts', function (Blueprint $table): void {
        ...
        Schema::table('property_financial_ledger_entries', fn (Blueprint $table) => $table->dropIndex('property_fin_ledger_creator_idx'));
        Schema::table('property_financial_ledger_lines', fn (Blueprint $table) => $table->dropIndex('property_fin_ledger_lines_user_idx'));
        Schema::table('property_financial_holds', fn (Blueprint $table) => $table->dropIndex('property_fin_holds_releaser_idx'));
        Schema::table('property_financial_disputes', function (Blueprint $table): void {

...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('property_payment_allocations', function (Blueprint $table): void {
            $table->index('beneficiary_user_id', 'property_payment_allocations_beneficiary_idx');
        });

        Schema::table('property_manual_payment_confirmations', function (Blueprint $table): void {
            $table->index('user_id', 'property_manual_confirmations_user_idx');
        });
        ...
        Schema::table('property_payouts', function (Blueprint $table): void {
            ...
            $table->index('recorded_by_user_id', 'property_payouts_recorded_by_idx');
        });

        Schema::table('property_financial_ledger_entries', function (Blueprint $table): void {
            $table->index('created_by_user_id', 'property_fin_ledger_entries_creator_idx');
        });
        ...
        Schema::table('property_financial_holds', function (Blueprint $table): void {
            $table->index('released_by_user_id', 'property_fin_holds_released_by_idx');
        });

        Schema::table('property_financial_disputes', function (Blueprint $table): void {
            $table->index('deal_financial_term_id', 'property_fin_disputes_deal_term_idx');
            $table->index('opened_by_user_id', 'property_fin_disputes_opened_by_idx');
            $table->index('resolved_by_user_id', 'property_fin_disputes_resolved_by_idx');
        });
        ...
        Schema::table('property_refunds', function (Blueprint $table): void {
            ...
            $table->index('recorded_by_user_id', 'property_refunds_recorded_by_idx');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('property_payment_allocations', function (Blueprint $table): void {
            $table->dropIndex('property_payment_allocations_beneficiary_idx');
        });

        Schema::table('property_manual_payment_confirmations', function (Blueprint $table): void {
            $table->dropIndex('property_manual_confirmations_user_idx');
        });

        Schema::table('property_payouts', function (Blueprint $table): void {
            $table->dropIndex('property_payouts_deal_term_idx');
            $table->dropIndex('property_payouts_payment_idx');
            $table->dropIndex('property_payouts_recorded_by_idx');
        });

        Schema::table('property_financial_ledger_entries', function (Blueprint $table): void {
            $table->dropIndex('property_fin_ledger_entries_creator_idx');
        });
        ...
        Schema::table('property_financial_holds', function (Blueprint $table): void {
            $table->dropIndex('property_fin_holds_released_by_idx');
        });

        Schema::table('property_financial_disputes', function (Blueprint $table): void {
            $table->dropIndex('property_fin_disputes_deal_term_idx');
            $table->dropIndex('property_fin_disputes_opened_by_idx');
            $table->dropIndex('property_fin_disputes_resolved_by_idx');
        });

        Schema::table('property_refunds', function (Blueprint $table): void {
            $table->dropIndex('property_refunds_payment_idx');
            $table->dropIndex('property_refunds_beneficiary_idx');
            $table->dropIndex('property_refunds_recorded_by_idx');
        });
    }
};
